...
import type {
  ...
  ModelObjectDependenciesResponse,
} from "../types.js";
...
/**
 * Make an authenticated request to the IcePanel API and return raw text
 */
...
export async function getModelObjectsCsv(
  landscapeId: string,
  versionId: string = "latest"
): Promise<string> {
  return apiRequestText(`/landscapes/${landscapeId}/versions/${versionId}/model/objects/export/csv`);
}

export async function getModelObjectDependenciesJson(
  landscapeId: string,
  modelObjectId: string,
  versionId: string = "latest"
): Promise<ModelObjectDependenciesResponse> {
  return apiRequest(
    `/landscapes/${landscapeId}/versions/${versionId}/model/objects/${modelObjectId}/dependencies/export/json`
  ) as Promise<ModelObjectDependenciesResponse>;
}
...
export async function getModelConnectionsCsv(
  landscapeId: string,
  versionId: string = "latest"
): Promise<string> {
  return apiRequestText(`/landscapes/${landscapeId}/versions/${versionId}/model/connections/export/csv`);
}
...
export async function getTags(
  ...
  const params = options.filter ? buildFilterParams(options.filter) : new URLSearchParams();
  const queryString = params.toString();
  const url = `/landscapes/${landscapeId}/versions/${versionId}/tags${queryString ? `?${queryString}` : ""}`;
  return apiRequest(url) as Promise<TagsResponse>;
}
...
export async function getTag(
  ...
  return apiRequest(`/landscapes/${landscapeId}/versions/${versionId}/tags/${tagId}`) as Promise<TagResponse>;
}
...
export async function getTagGroups(
  ...
  versionId: string = "latest",
  options: { filter?: Record<string, unknown> } = {}
): Promise<TagGroupsResponse> {
  const params = options.filter ? buildFilterParams(options.filter) : new URLSearchParams();
  const queryString = params.toString();
  const url = `/landscapes/${landscapeId}/versions/${versionId}/tag-groups${
    queryString ? `?${queryString}` : ""
  }`;
  return apiRequest(url) as Promise<TagGroupsResponse>;
}
...
export async function getDomains(
  ...
  const params = options.filter ? buildFilterParams(options.filter) : new URLSearchParams();
  const queryString = params.toString();
  const url = `/landscapes/${landscapeId}/versions/${versionId}/domains${queryString ? `?${queryString}` : ""}`;
  return apiRequest(url) as Promise<DomainsResponse>;
}
...
export async function getDiagramThumbnails(
  ...
  const params = options.filter ? buildFilterParams(options.filter) : new URLSearchParams();
  const queryString = params.toString();
  const url = `/landscapes/${landscapeId}/versions/${versionId}/diagrams/thumbnails${
    queryString ? `?${queryString}` : ""
  }`;
...
export async function getFlowThumbnails(
  ...
  const params = options.filter ? buildFilterParams(options.filter) : new URLSearchParams();
  const queryString = params.toString();
  const url = `/landscapes/${landscapeId}/versions/${versionId}/flows/thumbnails${
    queryString ? `?${queryString}` : ""
  }`;
