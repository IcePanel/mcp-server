...
export interface ModelObjectDependenciesResponse {
  incomingConnectionObjects: Record<string, unknown>;
  incomingConnections: Record<string, unknown>[];
  outgoingConnectionObjects: Record<string, unknown>;
  outgoingConnections: Record<string, unknown>[];
}
